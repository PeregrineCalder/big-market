...
public class DataSourceConfig {
    @Configuration
    @MapperScan(basePackages = "cn.peregrine.infrastructure.elasticsearch", sqlSessionFactoryRef = "elasticsearchSqlSessionFactory")
    ...
    @Configuration
    @MapperScan(basePackages = "cn.peregrine.infrastructure.dao", sqlSessionFactoryRef = "mysqlSqlSessionFactory")
