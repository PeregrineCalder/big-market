...
public class LogicTreeTest {
    ...
    public void test_tree_rule() {
        ...
        ruleTreeVO.setTreeName("决策树规则: 增加 DALL.E.3 画图模型");
        ruleTreeVO.setTreeDesc("决策树规则: 增加 ALL.E.3 画图模型");
        ...
        DefaultTreeFactory.StrategyAwardData data = treeEngine.process("peregrine", 100001L, 100);
