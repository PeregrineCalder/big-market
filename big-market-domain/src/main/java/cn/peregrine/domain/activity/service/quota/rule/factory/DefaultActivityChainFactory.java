package cn.peregrine.domain.activity.service.quota.rule.factory;

import cn.peregrine.domain.activity.service.quota.rule.IActionChain;
 ...
 * @package: cn.peregrine.domain.activity.service.rule.factory
 * @className: DefaultActivityChainFactory
 * @author: Peregrine Calder
 * @description: 责任链工厂
 * @date: 2024/4/26 23:07
 * @version: 1.0
 */
@Service
