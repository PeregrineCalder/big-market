package cn.peregrine.trigger.http;
...
import cn.peregrine.domain.activity.service.armory.IActivityArmory;
import cn.peregrine.domain.activity.service.quota.RaffleActivityAccountQuotaService;
import cn.peregrine.domain.award.model.entity.UserAwardRecordEntity;
import cn.peregrine.domain.award.model.valobj.AwardStateVO;
import cn.peregrine.domain.award.service.IAwardService;
...
public class RaffleActivityController implements IRaffleActivityService {
     ...
     * 入参：{"activityId":100001,"userId":"peregrine"}
     *
     * curl --request GET \
     ...
     * 入参：peregrine
     * <p>
     * curl -X POST http://localhost:8091/api/v1/raffle/activity/calendar_sign_rebate -d "userId=peregrine" -H "Content-Type: application/x-www-form-urlencoded"
     */
     ...
     * 判断是否签到接口
     * <p>
     * curl -X POST http://localhost:8091/api/v1/raffle/activity/is_calendar_sign_rebate -d "userId=peregrine" -H "Content-Type: application/x-www-form-urlencoded"
     */
